...
// NewAppWillActivate creates a new AppWillActivate event. 'target' is the app.
func NewAppWillActivate(target Target) *AppWillActivate {
	return &AppWillActivate{target: target}
}
