...
func platformNewImageFromBytes(buffer []byte) *Image {
	// RAW: Implement platformNewImageFromBytes for Windows
	return nil
}

func platformNewImageFromURL(url string) *Image {
	// RAW: Implement platformNewImageFromURL for Windows
	return nil
}

func platformNewImageFromData(data *ImageData) *Image {
	// RAW: Implement platformNewImageFromData for Windows
	return nil
}

func platformNewImageFromImage(other *Image, bounds geom.Rect) *Image {
	// RAW: Implement platformNewImageFromImage for Windows
	return nil
}
