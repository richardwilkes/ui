...
int platformClipboardChangeCount() {
	// RAW: Implement platformClipboardChangeCount for Windows
	return 0;
}

void platformClearClipboard() {
	// RAW: Implement platformClearClipboard for Windows
}

const char **platformClipboardTypes() {
	// RAW: Implement platformClipboardTypes for Windows
...
struct platformClipboardData platformClipboardData(char *type) {
	// RAW: Implement platformClipboardData for Windows
...
void platformSetClipboardData(char *type, int size, void *bytes) {
	// RAW: Implement platformSetClipboardData for Windows
}
