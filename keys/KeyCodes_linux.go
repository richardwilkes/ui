...
func init() {
	...
	InsertMapping(C.XK_Alt_L, &Mapping{KeyCode: OptionLeft, Name: LeftAltName})
	InsertMapping(C.XK_Alt_R, &Mapping{KeyCode: OptionRight, Name: RightAltName})
	InsertMapping(C.XK_Super_L, &Mapping{KeyCode: CommandLeft, Name: LeftCommandName})
	InsertMapping(C.XK_Super_R, &Mapping{KeyCode: CommandRight, Name: RightCommandName})
